...
import com.timealbum.moses.test3.MainActivity.JobIds;
...
public class PhotosContentJob extends JobService {
    ...
    static {
        JobInfo.Builder builder = new JobInfo.Builder(JobIds.PHOTOS_CONTENT_JOB,
                new ComponentName("com.timealbum.moses.test3", PhotosContentJob.class.getName()));
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        if (params.getTriggeredContentAuthorities() != null) {
            Log.d(TAG, "onStartJob: Authorities no error");
            boolean rescanNeeded = false;

            if (params.getTriggeredContentUris() != null) {
                Log.d(TAG, "onStartJob: Content URI no error");
                ...
                for (Uri uri : params.getTriggeredContentUris()) {
                    ...
                    Log.d(TAG, "onStartJob: " + path.toString());
                ...
                if (ids.size() > 0) {
                    ...
                    Log.d(TAG, "onStartJob: " + selection);
        ...
        mHandler.postDelayed(mWorker, 1000);
        return true;
    }
